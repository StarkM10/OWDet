...
# ---------------------------------------------------------------------------- #
_C.OWDet = CN()
_C.OWDet.ENABLE_THRESHOLD_AUTOLABEL_UNK = False
_C.OWDet.NUM_UNK_PER_IMAGE = 1
_C.OWDet.ENABLE_UNCERTAINITY_AUTOLABEL_UNK = False
_C.OWDet.ENABLE_CLUSTERING = False

_C.OWDet.CLUSTERING = CN()
_C.OWDet.CLUSTERING.ITEMS_PER_CLASS = 10
_C.OWDet.CLUSTERING.START_ITER = 100
_C.OWDet.CLUSTERING.UPDATE_MU_ITER = 200
_C.OWDet.CLUSTERING.MOMENTUM = 0.9
_C.OWDet.CLUSTERING.Z_DIMENSION = 64
_C.OWDet.CLUSTERING.MARGIN = 10.0

_C.OWDet.PREV_INTRODUCED_CLS = 0
_C.OWDet.CUR_INTRODUCED_CLS = 20
_C.OWDet.COMPUTE_ENERGY = False
_C.OWDet.ENERGY_SAVE_PATH = ''
_C.OWDet.SKIP_TRAINING_WHILE_EVAL = False
_C.OWDet.FEATURE_STORE_SAVE_PATH = ''
_C.OWDet.TEMPERATURE = 1.5
