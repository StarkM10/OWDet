...
def default_setup(cfg, args):
    ...
    if comm.is_main_process() and output_dir:
        ...
        if cfg.OWDet.COMPUTE_ENERGY:
            PathManager.mkdirs(os.path.join(output_dir, cfg.OWDet.ENERGY_SAVE_PATH))

        if cfg.OWDet.ENABLE_CLUSTERING:
            PathManager.mkdirs(os.path.join(output_dir, cfg.OWDet.FEATURE_STORE_SAVE_PATH))
