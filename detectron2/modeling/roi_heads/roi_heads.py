...
class ROIHeads(torch.nn.Module):
    ...
    def from_config(cls, cfg):
        return {
            ...
            "enable_thresold_autolabelling": cfg.OWDet.ENABLE_THRESHOLD_AUTOLABEL_UNK,
            "unk_k": cfg.OWDet.NUM_UNK_PER_IMAGE,
        }
...
class Res5ROIHeads(ROIHeads):
    ...
    def __init__(self, cfg, input_shape):
        ...
        self.enable_clustering = cfg.OWDet.ENABLE_CLUSTERING
        self.compute_energy_flag = cfg.OWDet.COMPUTE_ENERGY
        self.energy_save_path = os.path.join(cfg.OUTPUT_DIR, cfg.OWDet.ENERGY_SAVE_PATH)
        # fmt: on
    ...
    def log_features(self, features, proposals):
        ...
        location = '/home/fk1/workspace/OWDet/output/features/' + shortuuid.uuid() + '.pkl'
