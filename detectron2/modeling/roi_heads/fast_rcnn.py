...
class FastRCNNOutputs:
    ...
    def log_logits(self, logits, cls):
        data = (logits, cls)
        location = '/home/fk1/workspace/OWDet/output/logits/' + shortuuid.uuid() + '.pkl'
...
class FastRCNNOutputLayers(nn.Module):
    ...
    def from_config(cls, cfg, input_shape):
        return {
            ...
            "clustering_items_per_class" : cfg.OWDet.CLUSTERING.ITEMS_PER_CLASS,
            "clustering_start_iter" : cfg.OWDet.CLUSTERING.START_ITER,
            "clustering_update_mu_iter" : cfg.OWDet.CLUSTERING.UPDATE_MU_ITER,
            "clustering_momentum"   : cfg.OWDet.CLUSTERING.MOMENTUM,
            "clustering_z_dimension": cfg.OWDet.CLUSTERING.Z_DIMENSION,
            "enable_clustering"     : cfg.OWDet.ENABLE_CLUSTERING,
            "prev_intro_cls"        : cfg.OWDet.PREV_INTRODUCED_CLS,
            "curr_intro_cls"        : cfg.OWDet.CUR_INTRODUCED_CLS,
            "max_iterations"        : cfg.SOLVER.MAX_ITER,
            "output_dir"            : cfg.OUTPUT_DIR,
            "feat_store_path"       : cfg.OWDet.FEATURE_STORE_SAVE_PATH,
            "margin"                : cfg.OWDet.CLUSTERING.MARGIN,
            # fmt: on
        }
