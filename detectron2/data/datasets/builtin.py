...
if __name__.endswith(".builtin"):
    ...
    _root = '/media/D/datasets'
    # _root = '/media/D/Marui/datasets/VOCdevkit'
    register_all_coco(_root)
    register_all_lvis(_root)
    register_all_cityscapes(_root)
    register_all_cityscapes_panoptic(_root)
    register_all_pascal_voc(_root)
    # register_all_pascal_voc('/home/starkm/workspace/OWDet/datasets')
    # register_all_pascal_voc('/home/starkm/workspace/OWDet/datasets')
    # register_all_voc_style_coco('/home/fk1/workspace/OWDet/datasets')
